...
Route::rule('holdercn','index/holdercn/index');
Route::rule('holder_postcn','index/holdercn/info_post');
Route::rule('holder_infocn','index/holderinfocn/index');

Route::rule('equity','index/equity/index');
Route::rule('equitycn','index/equitycn/index');
Route::rule('equity_post','index/equity/info_post');
Route::rule('equity_postcn','index/equitycn/info_post');
Route::rule('equity_info','index/equityinfo/index');
Route::rule('equity_infocn','index/equityinfocn/index');

Route::rule('group','index/group/index');
Route::rule('groupcn','index/groupcn/index');
Route::rule('group_info','index/groupinfo/index');
Route::rule('group_infocn','index/groupinfocn/index');
Route::rule('referee_post','index/group/info_post');
Route::rule('referee_postcn','index/groupcn/info_post');
