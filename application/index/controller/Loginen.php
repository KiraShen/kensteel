...
class Loginen extends BaseHome {
    ...
    public function login(){
        ...
        ($user['password'] !== $password) && $this->error('The login password does not match the account number. Please reenter it!');
        ...
        $this->success('successful,login...', '@index_en');
    }

    public function logout() {
        session('iuser', null);
        session_destroy();
        $this->success('logout success！', '@index_en');
    }
}